...
![](
  <svg
      ...
      >
        <title id="titleId">MorganRuijie's GitHub Stats, Rank: C+</title>
        <desc id="descId">Total Stars Earned: 23, Total Commits in 2024 : 23, Total PRs: 1, Total Issues: 1, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 198.29862965476093;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >MorganRuijie's GitHub Stats</text>
    </g>
      </g>
